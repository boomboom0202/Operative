...
def export_statistics_excel(request):
    ...
    for workshop in Workshop.objects.all():
        ...
        for resource in Resource.objects.all():
            ...
            ws.cell(row=row_num, column=1, value=workshop.name)
            ws.cell(row=row_num, column=2, value=resource.name)
            ws.cell(row=row_num, column=3, value=resource.unit)
            
            ws.cell(row=row_num, column=4, value=month_stats['plan_month'])
            ws.cell(row=row_num, column=5, value=month_stats['plan_to_date'])
            ws.cell(row=row_num, column=6, value=month_stats['fact_month'])
            ws.cell(row=row_num, column=7, value=month_stats['deviation'])
            
            ws.cell(row=row_num, column=8, value=day_stats['plan_daily'])
            ws.cell(row=row_num, column=9, value=day_stats['fact_daily'])
            ws.cell(row=row_num, column=10, value=day_stats['deviation'])
            
            ws.cell(row=row_num, column=11, value=year_stats['year_plan_to_date'])
            ws.cell(row=row_num, column=12, value=year_stats['year_fact_to_date'])
            ws.cell(row=row_num, column=13, value=year_stats['year_deviation'])
